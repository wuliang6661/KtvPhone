 ...
 * 支付成功弹窗
 */
public class PayErrorDialog extends PopupWindow {
    ...
    public PayErrorDialog(Activity activity) {
        this.activity = activity;

        View dialogView = LayoutInflater.from(activity).inflate(R.layout.dialog_pay_error, null);

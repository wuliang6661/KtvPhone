 ...
 * 支付成功弹窗
 */
public class PaySuressDialog extends PopupWindow {
    ...
    public PaySuressDialog(Activity activity) {
        this.activity = activity;

        View dialogView = LayoutInflater.from(activity).inflate(R.layout.dialog_pay_suress, null);
